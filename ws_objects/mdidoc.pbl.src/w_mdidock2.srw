$PBExportHeader$w_mdidock2.srw
forward
global type w_mdidock2 from window
end type
type mdi_1 from mdiclient within w_mdidock2
end type
type st_1 from statictext within w_mdidock2
end type
type rbb_1 from ribbonbar within w_mdidock2
end type
end forward
...
event ue_refresh_xml();//rbb_1.ImportFromXMLFile( "RibbonBar_Demo.xml" )
end event
